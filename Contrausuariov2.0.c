...
int copioposiciondetabla1atabla2(int *tabla1, int *tabla2);
...
int main(int argc, char *argv[]) {
	...
	while(evalpos(tabla)==0 && contador<9 && movimiento.jugadamejor!=-33){ // N.B:: Antes tenía <10, por lo que se volverá loco si se agota el tablero
		...
		while(jugada_del_usuario<0 || tabla[jugada_del_usuario]!=0 || jugada_del_usuario>8){
